...
## 2.部署
```
wget https://raw.githubusercontent.com/bienao666/IPP/main/install/install.sh && chmod 777 install.sh && bash install.sh
```
默认账号：admin
默认密码：admin
